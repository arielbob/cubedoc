			...
			<section className='step column'>
				...
				<div className='row wrap'>
					<div className='card img-card'>
						<img src={require('../../img/3x3/oll_dot.png')}/>
						<span className='caption'>F R U R' U' F' f R U R' U' f</span>
					</div>
					<div className='card img-card'>
						<img src={require('../../img/3x3/oll_line.png')}/>
						<span className='caption'>F R U R' U' F'</span>
					</div>
					<div className='card img-card'>
						<img src={require('../../img/3x3/oll_square.png')}/>
						<span className='caption'>f R U R' U' f'</span>
					</div>
				</div>
			</section>
